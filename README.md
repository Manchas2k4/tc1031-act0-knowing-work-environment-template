...
Accede a la siguiente liga: HTTP y acepta la tarea. Esto creará tu repositorio de trabajo. En él, encontrarás el archivo "activity.h". En este archivo deberás desarrollar la implementación del problema presentado en esta actividad.  En la parte superior del archivo coloca, en comentarios, tus datos. Por ejemplo:
```
// =========================================================
// File: factorial.h
...
// =========================================================
```
Implementa, <span style="text-decoration-line: underline;">forma individual</span>, la función factiorial:
...
<td style="width: 30%; height: 10px; background-color: rgb(25, 99, 169);" rowspan="5"><span style="font-size: 18pt; color: rgb(255, 255, 255);">factorial</span></td>
...
<td style="width: 0px; height: 0px; background-color: rgb(183, 219, 255);">El factorial de n. Si n es un número negativo, deberá lanzar una excepción IllegalAction. </td>
</tr>
<tr style="height: 24px;">
